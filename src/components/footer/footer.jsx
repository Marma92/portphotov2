...
import { faEnvelopeSquare, faFilm } from '@fortawesome/free-solid-svg-icons';
import "./footer.css";
...
export class Footer extends Component {
  render() {
    return (
      ...
      <a href={darkroom}  target="_blank" rel="noreferrer" style={styles.icons} className='dr'><FontAwesomeIcon icon={faFilm} size="2x"/> </a>
